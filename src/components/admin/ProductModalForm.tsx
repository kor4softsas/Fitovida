...
export default function ProductModalForm({
  ...
  return (
    <div className="fv-modal-backdrop fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
      <div className="fv-modal-panel bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
